    ...
    <Grid item xs={12} lg={4} md={4} sm={6} display="flex" alignItems="stretch">
      {isLoading ? (
        ...
        <BlankCard className="hoverCard">
          ...
          >
            <CardMedia component="img" height="240" image={coverImg} alt="iguana verde" />
          </Typography>
          <CardContent>
            <Stack direction="row" sx={{ marginTop: '-45px' }}>
              <Tooltip title={author.name} placement="top">
                <Avatar aria-label="receita" src={author.avatar}></Avatar>
              </Tooltip>
              <Chip
            ...
            <Stack direction="row" gap={3} alignItems="center">
              ...
              <Stack direction="row" ml="auto" alignItems="center">
                <IconPoint size="16" />
                <small>{format(new Date(createdAt), 'E, d de MMM')}</small>
              </Stack>
            </Stack>
          </CardContent>
        </BlankCard>
