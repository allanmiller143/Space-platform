        ...
        >
          ...
          <Grid container spacing={2}>
            ...
            <Grid item xs={12} lg={12}>
              {totalMedia === 0 ? <Alert severity="error">Nenhuma Mídia Encontrada!</Alert> : null}
            </Grid>
          </Grid>

          <Typography variant="h6" mt={5} mb={2}>
            Anexos ({totalAttachment})
          </Typography>
          <Box>
            ...
            {totalAttachment === 0 ? <Alert severity="error">Nenhum Anexo Encontrado!</Alert> : null}
          </Box>
        </Box>
      ) : null}
    </>
