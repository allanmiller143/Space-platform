    ...
    if (mode === 'edit' && imovel) {
      setFormData({
        ...
        opcoesRapidas: {
          ...
          Ar_Condicionado : imovel.commodities.airConditioning,
          Playground : imovel.commodities.playground,
          Sala_de_eventos :  imovel.commodities.eventArea,
          Academia :imovel.commodities.gym,
          Varanda : imovel.commodities.porch,
          Energia_solar : imovel.commodities.solarEnergy,
          Portaria_24h : imovel.commodities.concierge,
          Quintal : imovel.commodities.yard,
          Area_Gourmet : imovel.commodities.gourmetArea,
