...
const ChatData = [
  {
    ...
    thumb: user1,
    recent: false,
    excerpt: 'Desenvolvedor de Sistemas',
    messages: [
      {
        ...
        type: 'text',
        attachment: [
          { icon: adobe, file: 'contrato-venda.pdf', fileSize: '2MB' },
          { icon: chrome, file: 'plano-imovel.fig', fileSize: '3MB' },
          { icon: figma, file: 'documentacao-imovel.html', fileSize: '1KB' },
          { icon: java, file: 'proposta-compra.zip', fileSize: '20MB' },
          { icon: zip, file: 'relatorio-transacao.js', fileSize: '2MB' },
        ],
        id: uniqueId(),
      },
      {
  ...
  },
  {
    ...
    thumb: user4,
    recent: true,
    excerpt: 'Aguarde do lado de fora do imóvel',
    messages: [
      {
        createdAt: sub(new Date(), { hours: 1 }),
        msg: chance.sentence({ words: 5 }),
